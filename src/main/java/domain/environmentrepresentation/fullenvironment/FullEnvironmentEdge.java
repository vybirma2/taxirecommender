...
public class FullEnvironmentEdge extends EnvironmentEdge {
    public FullEnvironmentEdge(int fromId, int toId, long wayID, Set<ModeOfTransport> permittedModes, float allowedMaxSpeedInMpS, int lengthInMetres, int category) {
